...
export default function ResetPasswordPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      await resetPassword({ email, code: fullCode, newPassword });
      setSuccess(true);
    } catch (err) {
            ...
            <div className="text-left mb-6">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 bg-input border border-border rounded-xl outline-none focus:border-primary transition-colors text-sm pr-11"
                />
                <button
                  type="button"
